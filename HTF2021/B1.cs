...
namespace HTF2021
{
    ...
    internal static class B1
    {
        ...
        {
            var date1 = parseRandomDate(temp_date1);
            var date2 = parseRandomDate(temp_date2);
